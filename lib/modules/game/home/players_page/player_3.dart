...
class Player3 extends StatefulWidget {
  const Player3({super.key});

  @override
  State<Player3> createState() => _Player3State();
}
                    ...
                    const Row(
                      ...
                      children: [
                        Align(
                          ...
                          child: HandCardsPlayer2(playerJogando: 4),
                        ),
                        Align(
                          alignment: Alignment.centerRight,
                          child: HandCardsPlayer4(playerJogando: 2),
                        ),
                      ],
                    ),
                    const Column(
                      ...
                      children: [
                        Align(
                          ...
                          child: HandCardsPlayer3(playerJogando: 1),
                        ),
                        Align(
                          alignment: Alignment.bottomCenter,
                          child: HandCards(playerJogando: 3),
                        ),
                      ],
                    ),
                    Align(
